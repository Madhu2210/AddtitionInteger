...
import { CHART_SERVICES, HEADER, ORDER_PAD } from '../../../config/ServiceURLs';
...
import { LOCAL_STORAGE, STREAMING_MODULES, SCREENS } from '../../../common/Constants'
...
const ChartWidgetComponent = (props) => {
    ...
    useEffect(() => {
        if (streamingResp && streamingResp.data && selectedSym) {
    ...
    function loadChart(forceReload) {
        ...
        if (selectedSym) {
            let data = {
                ...
                tradingURL: getBaseURL() + ORDER_PAD.PLACE_ORDER,
                symbolSearchURL: getMarketDataBaseURL() + HEADER.SYMBOL_SEARCH,
                socketURL:AppSettings.streamingURL,
