...
import { DASHBOARD_WIDGET_MODE, LOCAL_STORAGE,  THEMES } from '../../../common/Constants';
...
function NewsBaseComponent(props) {
    ...
    function getNewsCategory() {
        /*portfolio news not required in guest user*/
        // let skipitem = "Portfolio News"                  
        let news = JSON.parse(getItemFromSessionStorage(LOCAL_STORAGE.GUEST_NEWS_CATEGORY))
        // news = news.filter(item=>item.key != skipitem)
