...
import { ORDER_DIALOGS, ORDER_MODIFY_TYPE, ORDER_STATUS, ORDER_TYPES, THEMES } from '../../../../../common/Constants';
                ...
                <div className="orderDialog-bodyDetails-Row2">
                    ...
                    </span>
                    {
                        isExecutedOrder(props.orderBookDetails.symData.status) ?
                            <span className="details avgprice">
                                <span>
                    ...
                    <span className="details date-guest">
