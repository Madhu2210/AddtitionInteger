...
import {
    ...
    storeWatchlistScreenActiveFlag,
    storeWatchlistSortParams
} from '../../../../state/actions/Actions';

import LangText, { getLangText } from '../../../../common/lang/LangText'
import { getGuestUserBaseURL, sortByInt, sortByString, sortFlagFunc } from '../../../../common/CommonMethods'
...
function WatchlistBaseComponent(props) {
    ...
    function getSymbolsWatchGroup() {
        ...
        MsfFetch.placeRequest(
            getGuestUserBaseURL() + WATCHLIST_GUEST.GET_SYMBOL_WATCHGROUP,
            request,
    ...
    function onDeleteWatchGroup(deleteGroup) {
        ...
        if (!isPendingDeleteGroupRequest.current) {
            ...
            MsfFetch.placeRequest(
                getGuestUserBaseURL() + WATCHLIST_GUEST.DELETE_WATCHGROUP,
                request,
    ...
    function successRespCBDeleteWatchGroupName(response) {
        ...
        props.storeToastMsgProps({
            show: true,
            message: getLangText("WATCHLIST_MSG_DELETE_WATCHLIST_SUCCESS")
        })
        ...
        return (
            <div className="deleteMsg-div flex-center" style={{ flexDirection: "column" }}>
                <span className="labelText">
                    ...
                    <LangText name="WATCHLIST_MSG_DELETE_QUERY" />
                </span>
                <span className="valueText">{symCount}
                    <LangText name={symCount > 1 ?
...
const mapStateToProps = ({ watchlist, login }) => {
    return {
