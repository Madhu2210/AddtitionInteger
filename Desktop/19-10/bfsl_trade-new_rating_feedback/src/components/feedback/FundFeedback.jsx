...
import {fundRatingAndFeedback, storeAppTheme} from "../../state/actions/Actions";
import LangText from '../../common/lang/LangText';


 function FundFeedback() {
  console.log("Hello")
  ...
  const [ratingFeedbackFund, setratingFeedbackFund] = useState(true);
...
export default connect(mapStateToProps, mapDispatchToProps)(FundFeedback);
