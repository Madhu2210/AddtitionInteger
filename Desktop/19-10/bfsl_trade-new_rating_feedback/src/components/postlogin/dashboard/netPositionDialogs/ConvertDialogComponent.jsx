...
import { checkEmpty, checkInt, convertToUpperCase, getBaseURL, getColorBuySellAction, 
    isValidNumber } from '../../../../common/CommonMethods';
import {
    STK_PRODUCT_TYPES, INSTRUMENT_TYPES, ORDER_DIALOGS,
    TEXT_ORIENTATION, TRADE_PRODUCT_TYPES, THEMES
...
function ConvertDialogComponent(props) {
    ...
    useState(() => {
        ...
        if (instrument === INSTRUMENT_TYPES.STK) {
            let typeList = Object.assign([], STK_PRODUCT_TYPES)
    ...
    function onClickConvert() {
        ...
        if (convertQty && convertQty.length) {
            if (convertQty == 0) {
                setConQtyErr(getLangText('DASHBOARD_INVALID_QTY', 'DASHBOARD'))
                ...
                MsfFetch.placeRequest(
                    getBaseURL() + TRADE.POS_CONVERSION,
                    request,
