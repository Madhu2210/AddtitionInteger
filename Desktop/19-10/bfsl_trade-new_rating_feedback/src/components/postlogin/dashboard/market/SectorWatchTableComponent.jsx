...
function SectorWatchTableComponent(props) {
    ...
    useEffect(() => {
        if (props.marketList && props.marketList.length && streamingDataList.length) {
            streamingDataList.map((item) => {
                let isSymVisible = props.marketList.findIndex((i) => {
    ...
    function getConstituentsData() {
        ...
        setStreamingDataList(props.marketList)
        streamingSubscription(props.marketList)
    }

    function getConstituentsDataError() {
        setErrorMsg(props.marketListErr)
            ...
            return (
                <div className="marketMovers-baseTable">
                    <table className="ipoPerformance-table">
                        ...
                        <tbody id="constituentsTable" className="tbody-scroller"
...
const mapStateToProps = ({ indicesDetails, settings }) => {
    return {
...
export default
connect(mapStateToProps, mapDispatchToProps)(WidgetLoader(LazyLoading(withStreaming(SectorWatchTableComponent))));