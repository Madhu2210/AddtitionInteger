...
import {
    ...
    scrollToTop, checkEmpty, sortFlagFunc, sortByString, sortByInt, convertToFloat, getBackOfficeBaseURL
} from '../../../../common/CommonMethods';
import { HOLDINGS } from '../../../../config/ServiceURLs';
import { storeHoldingsResponse } from '../../../../state/actions/Actions';
import LangText from '../../../../common/lang/LangText';
import { storeAllHoldingsResponseToStore, storeHoldingsResponseToStore } from '../../../../common/Bridge';
...
function HoldingsHeaderTabComponent(props) {
    ...
    return (
        ...
        >
            <div className="label">
                <span className="head holdings-tab"><LangText module="HEADER" name="HOLDINGS" /></span>
                    {/* <span className="values-count">({checkEmpty(holdingsLength)})</span>
...
const mapStateToProps = ({ holdings }) => {
    return {
        ...
        goToHoldings: holdings.goToHoldings,
        landingFromEdisFlag: holdings.landingFromEdisFlag
    }
}
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        // storeAllHoldingsResp: (s) => {dispatch(storeAllHoldingsResp(s))}
    }
}
