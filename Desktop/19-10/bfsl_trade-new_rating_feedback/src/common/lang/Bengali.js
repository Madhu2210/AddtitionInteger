...
export const bengali = {
    ...
    LOGIN: {
        ...
        NEED_HELP_QUERY: "সাহায্য দরকার?",
        USERID_TXT: "ইউজার আইডি",
        USERID_PHOLDER: "আপনার ইউজার আইডি প্রদান করুন   ",
        PASSWORD_TXT: "পাসওয়ার্ড ",
        PASSWORD_PHOLDER: "আপনার পাসওয়ার্ড প্রদান করুন",
        PAN_TXT: "প্যান",
        DOB_TXT: "ডিওবি ",
        OTP: "OTP",
        PAN_DOB_PHOLDER: "PAN/DOB(DDMMYYYY)",
        PAN_PHOLDER: "আপনার প্যান প্রদান করুন",
        ...
        MEMBERSHIP_DETAILS: "মেম্বারশিপ ডিটেইল্স",
    ...
    MENU: {
        ...
        MARKETS: "মার্কেট",
        ALERT: "অ্যালার্ট",
        FUND_TRANSFER: "লিমিট/ফান্ড ট্রান্সফার ",
        REPORTS: "রিপোর্ট",
        SETTINGS: "সেটিংস",
    ...
    BUTTONS: {
        ...
        ADD_WATCHLIST: "ওয়াচলিস্ট অ্যাড করুন",
        ADD_SYMBOL: "চিহ্ন যোগ করুন",
        ADD_FUNDS: "ফান্ড অ্যাড করুন",
        FUNDS: "FUNDS",
        CREATE: "Create",
        START_NOW: "এখুনি স্টার্ট করুন",
        ...
        WITHDRAW_FUNDS: "ফান্ড উইথড্র করুন",
        ...
        CREATE_ALERT_BTN: "অ্যালার্ট তৈরী করুন",
        ...
        SQUAREOFF: "SQUAREOFF",
        SQUAREOFF_ALL: "সব স্কোয়ারঅফ",
        DESELECT: "সব অনির্বাচিত করুন",
        BUY_SYM: "B",
        SELL_SYM: "S",
        WEEKLY: "W",
        ORDER: "ORDER",
        CANCEL_IN_NETPOSN: "বাতিল",
    ...
    SYMBOL_SEARCH: {
        ...
        ADD_TO: "Add to",
        PLACE_HOLDER_ALERT_SEARCH: "নতুন সতর্কতা যোগ করতে চিহ্ন খুঁজুন ",
    ...
    TABLE_HEADERS: {
        ...
        FII_CASH: 'FII ক্যাশ ',
        DII_CASH: 'DII নগদ ',
        FII_FUTURES: 'FII ফিউচার ',
        FII_OPTIONS: 'FII বিকল্প  ',
    ...
    MARKET_BASE_WIDGET_MENUS: {
        ...
        GLOBAL_INDICES: "বৈশ্বিক সূচক "
    },
    MARKET_EQUITY_MENU_ARRAY: {
        TOP_GAINERS: "শীর্ষ লাভকারী ",
        TOP_LOSERS: "শীর্ষ লোকসানকারী",
        FT_WEEK_HIGH: '52 সপ্তাহ উচ্চ ',
        FT_WEEK_LOW: '52 সপ্তাহ নিম্ন',
        ACTIVE_VOLUME: 'সক্রিয় ভলিউম ',
        ACTIVE_VALUE: 'সক্রিয় মান ',
        BULK_DEALS: 'বাল্ক ডিল ',
        BLOCK_DEALS: 'ব্লক ডিল ',
        FII_DII_ACTIVITY: 'FII DII কার্যকলাপ ',
        IPO_PERFORMANCE: 'IPO পারফরম্যান্স '
    },
    ...
    MARKET_DERIVATIVE_MENU_ARRAY: {
        MOST_ACTIVE: "সবচেয়ে সক্রিয় ",
        PUT_CALL_RATIO: "",
        OI_GAINERS: 'OI লাভকারী ',
        OI_LOSERS: 'OI লোকসানকারী',
    },
    ...
    ORDERPAD: {
        ...
        CONFIRM_SELL_ORDER: "সেল অর্ডার নিশ্চিত করুন ",
        CONFIRM_BUY_ORDER: "বাই অর্ডার নিশ্চিত করুন ",
        ...
        VALIDITY: "বৈধতা ",
        AFTER_MARKET_ORDER: "মার্কেট অর্ডারের পর ",
        ...
        MARKET_PROTECTION: "বাজার সুরক্ষা ",
        TRADE_QTY: "TRADE QTY",
        ORDER_QTY: "ORDER QTY",
        AVG_PRICE: "গড় মূল্য",
    ...
    DASHBOARD: {
        ACTIVATE_FUTURE: "আপনার ফিউচার এবং অপশন অ্যাক্টিভেট করুন ",
        STEPS_TO_COMPELTE: "সম্পূর্ণ করতে কয়েকটি ধাপ",
        CONVERT_TO: "কনভার্ট করুন",
        TOTAL_QUANTITY: "TOTAL QUANTITY",
    ...
    FUNDS: {
        ...
        MARGIN_USED: "ব্যবহৃত মোট মার্জিন ",
        AVAILABLE_FUNDS: "উপলব্ধ ফান্ড",
        VIEW_STMT: "View Statement",
        ENTER_WITHDRAW_AMT: "উইথড্রলের পরিমাণ লিখুন ",
        WITHDRAWABLE_AMT: "উইথড্রয়েবেল অ্যামাউন্ট :",
        FUNDS_VALIDA_MSG: "Please enter a Value",
        CASH_EQUIVALENT: "ক্যাশ ইকুইভ্যালেন্ট",
        CLEAR_CASH_BALANCE: "Clear Cash Balance",
        NOTIONAL_BALANCE: "নোশনাল ক্যাশ ",
        PAY_IN_AMOUNT: "পরিমাণে অর্থ প্রদান করুন ",
        PAY_OUT_AMOUNT: "পরিশোধ মুল্য ",
        MARGIN_UTILIZED: "মার্জিন ব্যবহার করা হয়েছে",
        REALISED_MTOM: "রিয়েলাইজ্ড MTM ",
        UNREALISED_MTOM: 'আনরিয়েলাইজ্ড MTM',
        SPAN_MARGIN: 'স্প্যান মার্জিন ',
        EXPOSURE_MARGIN: 'এক্সপোজার মার্জিন ',
        PREMIUM_PRESENT: 'উপস্থিত প্রিমিয়াম',
        VAR_MARGIN: 'VAR Margin',
        ELM_MARGIN: 'ELM Margin',
        NET_CASH_AVL: 'উপলব্ধ নেট ক্যাশ ',
        CASH_BALANCE: 'ক্যাশ ব্যালেন্স',
        COLLATERAL_VALUE: 'সমান্তরাল মূল্য ',
        FO_SPAN_MARGIN_NRML_PRESENT: 'FO SPAN Margin NRML Present',
        FO_SPAN_MARGIN_MIS_PRESENT: 'FO SPAN Margin MIS Present',
        SCRIP_BSKT_MARGIN_PRESENT: 'EQ ক্যাশ মার্জিন ',
        DELIVERY_MARGIN_PRESENT: 'ডেলিভারি মার্জিন ',
        ...
        CANCEL_REQUEST_MSG: 'অনুরোধ সফলভাবে বাতিল করা হয়েছে ',
        WITHDRAW_AMT: 'Withdraw Amount  -',
        BASIC_VIEW: 'বেসিক ভিউ ',
        DETAILED_VIEW: 'বিস্তারিত দেখুন ',
        NO: "না ",
        YES: 'হ্যাঁ',
        CANCEL_REQ_CONFIRMATION: ' আপনি কি নিশ্চিত আপনি উইথড্র রিকোয়েস্ট বাতিল করতে চান ?',
        FUNDS_TRANSFER: 'ফান্ড ট্রান্সফার',
        LIMITS: 'লিমিট',
    ...
    PROFILE: {
        ...
        PHONE: 'ফোন ',
        SEGMENTS: 'সেগমেন্ট ',
        TYPENID: 'টাইপ এবং আইডি ',
        NOMINEE: 'নমিনী',
        POA: 'POA',
        ADDRESS: 'ঠিকানা ',
        BANK_DETAILS: 'ব্যাঙ্কের নাম এবং অ্যাকাউন্ট নম্বর ',
        ...
        UPLOAD_PROF_PIC: 'প্রোফাইল পিকচার আপলোড করুন',
        CHOOSE_FILE: 'আপলোড করার জন্য একটি ফাইল বেছে নিন ',
        MAX_FILESIZE: 'ম্যাক্স ফাইল সাইজ : 3MB',
        REMOVE_PROFILE_PIC: 'আপনি কি আপনার প্রোফাইল পিকচার সরাতে চান  ?',
    ...
    SETTINGS: {
        SETTINGS: "সেটিংস",
        CHANGE_STG_MSG: "আপনার প্রোফাইল এবং অ্যাকাউন্ট সেটিংস পরিবর্তন করুন ",
        CHANGE_PWD: "পাসওয়ার্ড পরিবর্তন করুন ",
        SET_PWD: "নতুন পাসওয়ার্ড সেট করুন ",
        NTFTNG_STNG: "Notification Settings",
        NTFTNG_MSG: "Notification permissions",
        DARK_THEME: "ডার্ক থিম ",
        THEME_MSG: "আলোর সংমিশ্রণ নির্দেশ করে ",
    ...
    IPO: {
        IPO_s: "IPOs",
        OPEN_IPO: "ওপেন IPO ",
        UPCOMING_IPO: "আসন্ন IPO",
        CLOSED_IPO: "বন্ধ IPO",
        ORDERBOOK: "অর্ডার বই",
        ORDER_HISTORY: "অর্ডার হিস্টোরি",
        SYMBOL: "চিহ্ন",
        ISSUE_OPEN_DATE: "ইস্যু খোলার তারিখ",
        ...
        ISSUE_PRICE: "ইস্যু মূল্য ",
        LTP: "এলটিপি",
        IPO_PERFORM_PER: "IPO পারফরম্যান্স  %",
        ORDER_QTY: "ORD.QTY",
        INVES_AMT: "INVES.AMT",
        NET_PL: "NET P&L",
        BID_ID: "BID ID",
    ...
    BO: {
        BO_S: "রিপোর্ট",
        FINANCIAL_LEDGER: "আর্থিক লেজার",
        FUND_TRANSACTION: "ফান্ড লেনদেন ",
        TRADE_SUMMARY: "ট্রেড সামারি",
        PL_REPORT: "P&L Report",
        COST_REPORT: "কস্ট রিপোর্ট  ",
        CONTRACT_NOTE_DOWNLOAD: "চুক্তি নোট ডাউনলোড ",
        VIEW_LAST_TRANSACTION: "শেষ 10টি লেনদেন দেখুন ",
        CLIENT_HOLDINGS: "ক্লায়েন্ট হোল্ডিংস ",
        DIVIDEND_REPORT: "লভ্যাংশ রিপোর্ট ",
        DP_TRANSACTION: "DP লেনদেন ",
        INTEREST_REPORT: "ইন্টারেস্ট রিপোর্ট ",
    ...
    ALERT: {
        SET_ALERT: "অ্যালার্ট সেট করুন ",
        ALERT_ME_WHEN: "আমাকে অ্যালার্ট করুন যখন",
        ALERT_ME_IF: "আমাকে অ্যালার্ট করুন যদি",
        CURRENT_VALUE: "বর্তমান মূল্য  :",
        ENTER_VALUE: "মূল্য প্রদান করুন",
        ENTER_ALERT_NAME: "আপনার অ্যালার্টের নাম দিন (অপ্ট) ",
        NOTIFY_ON: "অবহিত করুন ",
        SMS: "SMS",
        EMAIL: "ইমেইল ",
        ALERT_INFO: "তৈরির তারিখ থেকে 90 দিনের মধ্যে অ্যালার্টের মেয়াদ শেষ হয়ে যাবে ",
        PLACE_HOLDER_NAME_ALERT: "আপনার ট্রিগারের নাম দিন",
        ALERT_SUCCESS: "অ্যালার্ট সফলভাবে তৈরি করা হয়েছে.",
        ALERT_MODIFY: "অ্যালার্ট সফলভাবে পরিবর্তিত হয়েছে ",
        ALERT_DELETE: "অ্যালার্ট সফলভাবে মুছে ফেলা হয়েছে",
        MY_TRIGGERS: "আমার ট্রিগার ",
        PENDING_ALERTS: "পেন্ডিং অ্যালার্ট",
        TRIGGERED_ALERTS: "ট্রিগার করা অ্যালার্ট",
        NO_OF_ALERTS: "অ্যালার্টের সংখ্যা  :",
        NAME: "নাম : ",
        ALERT_TYPE: "অ্যালার্টের ধরন ",
        ALERT_CONDITION: "অ্যালার্টের অবস্থা",
        ALERT_VALUE: "অ্যালার্টের মান",
        ALERT_ERR_MSG: "অনুগ্রহ করে মান প্রদান করুন",
    ...
    LAS: {
        LOAN_AGAINST_SECURITI: "সিকিউরিটির বিপরীতে ঋণ",
        CONFIRM_KYC: "আপনার  KYC নিশ্চিত করুন ",
        LOAN_DETAILS: "LOAN AMOUNT",
        E_AGREEMENT: "ই-চুক্তি",
        E_MANDATE: "ই-ম্যান্ডেট",
        E_PLEDGE: "ই-প্লেজ",
        CONFIRM_STG: "আপনার  KYC নিশ্চিত করুন ",
        ...
        KYC_HEAD_FIRST: " অ্যাকাউন্টের বিবরণ",
        EMAIL: "ইমেইল",
        PHONE: "ফোন",
        PAN: "প্যান",
        DOB: "ডিওবি ",
        ADDRESS: "Current address",
        KYC_HEAD_SECOND: "ডিফল্ট ব্যাংক এবং অ্যাকাউন্ট নম্বর",
        DP_ID: "ডিপিআইডি এবং ক্লায়েন্ট আইডি",
        NOTE: "Note :",
        IFSC: "IFSC CODE-",
    ...
    AVAIL_LOAN: {
        ...
        LOAN_AGAINST_SECURITY: "সিকিউরিটির বিপরীতে ঋণ",
        FAQ: "HELP & FAQS",
        LOAN_AGAINST_SHARES: "সিকিউরিটির বিপরীতে ঋণ",
    ...
    AVAIL_LOAN_DIALOG_CONTENT: {
        ...
        DEFAULT_BANK: "ডিফল্ট ব্যাংক এবং অ্যাকাউন্ট নম্বর",
        PRIMARY_BANK:"PRIMARY BANK",
        WITHDRAWAL_FUNDS:"ফান্ড উইথড্র করুন",
        CANCEL_BUTTON:"বাতিল",
