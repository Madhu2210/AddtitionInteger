...
export const RATING_FEEDBACK = {
    ...
    BAD_LINE1: "BAD_LINE1",
    BAD_LINE2: "BAD_LINE2",
    GOOD_LINE1: "GOOD_LINE1",
    GOOD_LINE2: "GOOD_LINE2",
...
export const IPO_NCD_RATING_FEEDBACK = {
    IPO_NCD_EXPERIENCE: "IPO_NCD_EXPERIENCE",
    HORRIBLE: "HORRIBLE",
    SATISFIED: "SATISFIED",
    GREAT: "GREAT",
    IPO_BAD_MSG1: "IPO_BAD_MSG1",
    IPO_BAD_MSG2: "IPO_BAD_MSG2",
    IPO_BAD_MSG3: "IPO_BAD_MSG3",
    IPO_BAD_MSG4: "IPO_BAD_MSG4",
    IPO_BAD_MSG5: "IPO_BAD_MSG5",
    IPO_BAD_MSG6: "IPO_BAD_MSG6",
    IPO_BAD_LINE1: "IPO_BAD_LINE1",
    IPO_BAD_LINE2: "IPO_BAD_LINE2",
    IPO_AVERAGE_MSG1: "IPO_AVERAGE_MSG1",
    IPO_AVERAGE_MSG2: "IPO_AVERAGE_MSG2",
    IPO_AVERAGE_MSG3: "IPO_AVERAGE_MSG3",
    IPO_AVERAGE_MSG4: "IPO_AVERAGE_MSG4",
    IPO_AVERAGE_LINE1: "IPO_AVERAGE_LINE1",
    IPO_AVERAGE_LINE2: "IPO_AVERAGE_LINE2",
    IPO_GOOD_MSG1: "IPO_GOOD_MSG1",
    IPO_GOOD_MSG2: "IPO_GOOD_MSG2",
    IPO_GOOD_MSG3: "IPO_GOOD_MSG3",
    IPO_GOOD_MSG4: "IPO_GOOD_MSG4",
    IPO_CMNT_TEXT: "IPO_CMNT_TEXT",
    IPO_GOOD_LINE1: "IPO_GOOD_LINE1",
    IPO_GOOD_LINE2: "IPO_GOOD_LINE2",
    

}

export const REPORT_RATING_FEEDBACK = {
    REPORT_EXPERIENCE: "REPORT_EXPERIENCE",
    NOT_HAPPY: "NOT_HAPPY",
    REPORT_SATISFIED: "REPORT_SATISFIED",
    REPORT_GREAT: "REPORT_GREAT",
    REPORT_BAD_MSG1: "REPORT_BAD_MSG1",
    REPORT_BAD_MSG2: "REPORT_BAD_MSG2",
    REPORT_BAD_MSG3: "REPORT_BAD_MSG3",
    REPORT_BAD_MSG4: "REPORT_BAD_MSG4",
    REPORT_BAD_MSG5: "REPORT_BAD_MSG5",
    REPORT_BAD_LINE1: "REPORT_BAD_LINE1",
    REPORT_AVERAGE_MSG1: "REPORT_AVERAGE_MSG1",
    REPORT_AVERAGE_MSG2: "REPORT_AVERAGE_MSG2",
    REPORT_AVERAGE_MSG3: "REPORT_AVERAGE_MSG3",
    REPORT_AVERAGE_MSG4: "REPORT_AVERAGE_MSG4",
    REPORT_AVERAGE_LINE1: "REPORT_AVERAGE_LINE1",
    REPORT_AVERAGE_LINE2: "REPORT_AVERAGE_LINE2",
