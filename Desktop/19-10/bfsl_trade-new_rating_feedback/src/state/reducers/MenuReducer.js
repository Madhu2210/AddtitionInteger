...
import {
    ...
    STORE_ALERT_FLAG, STORE_HELP_AND_SUPPORT, STORE_RATING_AND_FEEDBACK, FUND_RATING_AND_FEEDBACK
...
const menu = (state = initialState, action = {}) => {
    switch (action.type) {
        ...
        case FUND_RATING_AND_FEEDBACK:
                return Object.assign({}, state, { ratingFeedbackFund: action.payload })
        default:
            return state;
    }
};
