...
module.exports = {
    entry: {
        core: "./sample-template-webpack.js"
    },
    mode: env,
    module: {
        /**
    ...
    output: {
		...
		path: path.join(__dirname, "../public/chartiq")
    },
    plugins: [
        /**
        ...
        new CopyPlugin({
            patterns: [
				...
				{
					from: path.join(defaultDir, "js/thirdparty/custom-elements.min.js"),
					to: "js/thirdparty/custom-elements.min.js"
				},
				// {
				// 	from: path.join(__dirname, "./public/msf-js-weblib-base.js"),
				// 	to: "js/thirdparty/msf-js-weblib-base.js"
				// },
				{
					from: path.join(defaultDir, "examples/templates/partials/sample-template-advanced-context.html"),
					to: "examples/templates/partials/sample-template-advanced-context.html"
				},
				
				{ from: 'marketTimings.json', to: 'marketTimings.json' }
            ]
        }),
        /**
		...
		new HtmlWebpackPlugin({
			template: './multiCharts.html',
			filename: 'multiCharts.html',
			inject: 'body'
		}),
        /**
