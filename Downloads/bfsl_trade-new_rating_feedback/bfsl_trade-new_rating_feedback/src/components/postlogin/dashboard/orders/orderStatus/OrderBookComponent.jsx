...
import {
    ...
    replaceComma, getFormatedDate, AF_EventTriggered
...
function OrderBookComponent(props) {
    ...
    function onSelectedStatus(item) {
        setOrderStatus(item);
        AF_EventTriggered(AF_EVENT_NAMES.ORDERBOOK , item.name)
    }
    ...
    function getOrderBook() {
        ...
        MsfFetch.placeRequest(
            getBaseURL() + TRADE.GET_ORDER_BOOK,
            request,
    ...
    function getTradeBook(from = startDate, to = endDate) {
        ...
        MsfFetch.placeRequest(
            getBaseURL() + TRADE.GET_TRADE_BOOK,
            request,
    ...
    function getSelectedTab(currentselectedtab) {
        ...
        if (currentselectedtab === ORDER_STATUS_TAB.ORDERBOOK){
            getOrderBook()
            AF_EventTriggered(currentselectedtab , currentselectedtab,{"onLoad":"orderBook"})
        }
        else
            getTradeBook()
        AF_EventTriggered(currentselectedtab , currentselectedtab)
    }
