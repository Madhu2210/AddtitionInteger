          ...
          {parentHeader && (
            <>
              ...
              <LangText module="RATING_FEEDBACK" name="RATING_MSG" />
                {/* Your rating and feedback is much valuable to us for serving you
                the best */}
              </div>
      ...
      {successCard && (
        <>
          <center className="success">
            ...
            <span className="txt-success">Success</span>
            ...
            <h5>Your Feedback is Invaluable to Us</h5><br />
            <h5>We promise to improve your experience in the coming days</h5>
            </div>
          </center>
        </>
      )}
