...
import { getGuestUserBaseURL, placeGetRequest } from '../../../common/CommonMethods'
import { PROFILE_GUEST } from '../../../config/ServiceURLs'
...
function ProfileImageComponent(props) {
    ...
    function onSubmitRemoveImg() {
        let url = getGuestUserBaseURL() + PROFILE_GUEST.REMOVE_USER_PROFILE
    ...
    function onUploadProfilePic() {
        ...
        fetch(getGuestUserBaseURL() + PROFILE_GUEST.UPLOAD_USER_PROFILE, {
            method: 'POST',
            credentials: 'include',
            body: formData
        }).then(response => {
            ...
            <div className="attach-file">
                <div className="upload-action">
                    <span className="upload-here">
                        <LangText module="PROFILE" name="CHOOSE_FILE" />
                ...
                <div className="remove-pic"> {
                    !remveImg ?
                        <span className="remove-img">
                            <LangText  name="REMOVE_PROFILE_PIC" />
