...
import {
    ...
    storeOrderFieldValues, storeOrderpadSelectedSym, storeOrderPadDialogDetails, storeOrderDialogDetails
} from '../../../../state/actions/Actions';

import {
    checkEmpty, convertToUpperCase, getColorCode,
    getDispSymbolName, isBuyTradeAction,
...
import {  gotoOrderDialog, gotoTrade } from '../../../../common/Bridge';
...
function NetPositionsTableComponent(props) {
    ...
    // const [selectedFilter, setSelectedFilter] = useState(NET_POSITION_HEADER_FILTER_CONST[0])
    ...
    //         })
    //         console.log("filter", filteredEquity)
    //         console.log('availableList', availableList)
    //         if (productType.key === 'all') {
    //             setListEquityLen(Object.keys(filteredEquity).length)
        ...
        <div className="orderTable-base net-position">
            ...
            'selected' : ''}`}
                    onClick={() => getSelectedFilter(NET_POSITION_FILTERS.ALL_POSTIONS)}>
                        ...
                        <div className="positions-count">{listLength}</div>
                    </div>
            ...
            'selected' : ''}`}
                    ...
                    >
                        ...
                        <div className="equity-count">{listEquityLen}</div>
                    </div>
            ...
            'selected' : ''}`}
                ...
                <div className="filter-right">
                    ...
                    {select ? <div className="squareoff cursor squareoff"
                        ...
                        onClick={() => getDeselectAll()}>Deselect All</div>}
                </div>
            </div> */}
            {/* {selectedFilter === NET_POSITION_FILTERS.EQUITY ?
